        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Início', 'Como Funciona', 'Diferenciais', 'Galeria', 'Depoimentos', 'FAQ'].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase().replace(' ', '')}`} className="text-gray-400 hover:text-brand-gold text-sm transition-all duration-300 flex items-center gap-3 group translate-x-0 hover:translate-x-2">
